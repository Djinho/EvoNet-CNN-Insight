...
logging.basicConfig(filename='error_group3.txt', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
logging.info("Started bayesian_optimization_group3.py script")
