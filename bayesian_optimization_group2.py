...
logging.basicConfig(filename='error_group2.txt', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
logging.info("Started bayesian_optimization_group2.py script")
...
optimal_params_df.to_csv("optimal_params_group2.csv")

logging.info("Completed bayesian_optimization_group2.py script")
