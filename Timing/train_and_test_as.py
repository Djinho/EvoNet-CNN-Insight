# -*- coding: utf-8 -*-
"""train_and_test_AS.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/github/Djinho/EvoNet-CNN-Insight/blob/main/model_training/Ancient_strong/train_and_test_AS.ipynb
...
*   Simulate data for late and strong selection selrange = seq 0 300 300 / timerange = 0.1 , 100kya
...
net_LCT.save(path + 'net_LCT.LS');

net_LCT = load_imanet(path + 'net_LCT.LS')
